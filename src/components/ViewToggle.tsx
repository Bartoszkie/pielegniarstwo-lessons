  ...
  return (
    <div className="flex w-full sm:w-auto bg-bg-secondary rounded-[10px] sm:rounded-[12px] p-0.5 sm:p-1 border border-border">
      <button
        ...
        className={`flex-1 sm:flex-initial px-3 sm:px-5 py-2 sm:py-2.5 border-none bg-transparent font-sans text-xs sm:text-sm font-medium cursor-pointer rounded-sm transition-all duration-200 ${
          currentView === 'month'
